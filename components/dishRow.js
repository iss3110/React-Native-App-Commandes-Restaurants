...
export default function DishRow({ name, description, id, price, image, category, activeCategory }) {
    ...
    // Vérifie si la catégorie du plat correspond à la catégorie active
    const isCategoryActive = category === activeCategory;

    return (
        <>
             <View className={`flex-row items-center bg-white p-3 rounded-3xl shadow-2xl mb-3 mx-2 ${isCategoryActive ? 'bg-gray-200' : ''}`}>
