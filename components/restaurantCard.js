        ...
        <View className="px-3 pb-4 space-y-2">
          ...
          <View className="flex-row items-center space-x-1">
              ...
              <Text className="text-xs">
                  ...
                  <Text className="text-gray-700"> ({reviews}4.2k Avis)</Text> · <Text className="font-semibold text-gray-700">{type}</Text>
              </Text>
          </View>
          <View className="flex-row items-center space-x-1">
              <Icon.MapPin color="gray" width={15} height={15} />
              <Text className="text-gray-700 text-xs"> Adresse : {address}</Text>
          </View>
        </View>
      </View>
