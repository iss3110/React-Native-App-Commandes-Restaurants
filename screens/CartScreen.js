  ...
  return (
    <View className=" bg-white flex-1">
      ...
      <View className="relative py-4 shadow-sm">
        ...
        <View>
            <Text className="text-center font-bold text-xl">Votre panier</Text>
     ...
     {/* delivery time */}
      <View style={{backgroundColor: themeColors.bgColor(0.2)}} className="flex-row px-4 items-center">
            ...
            <Text className="flex-1 pl-4">Livraison dans 20-30 minutes</Text>
            <TouchableOpacity>
                ...
                Object.entries(groupedItems).map(([key, items])=>{
                    return (
                        ...
                        className="flex-row items-center space-x-3 py-2 px-4 bg-white rounded-3xl mx-2 mb-3 shadow-md">
                            ...
                            <Text className="font-semibold text-base">{items[0]?.price}Dhs</Text>
                            <TouchableOpacity 
     ...
     {/* totals */}
      <View style={{backgroundColor: themeColors.bgColor(0.2)}} className=" p-6 px-8 rounded-t-3xl space-y-4">
            <View className="flex-row justify-between">
                ...
                <Text className="text-gray-700">{basketTotal}Dhs</Text>
            </View>
            <View className="flex-row justify-between">
                <Text className="text-gray-700">Frais de livraison</Text>
                <Text className="text-gray-700">{deliveryFee}Dhs</Text>
            </View>
            <View className="flex-row justify-between">
                <Text className="font-extrabold">Total</Text>
                <Text className="font-extrabold">{basketTotal+deliveryFee}Dhs</Text>
            </View>
            <View>
                <TouchableOpacity 
                style={{backgroundColor: themeColors.bgColor(1)}} 
                ...
                className="p-3 rounded-full">
                    <Text className="text-white text-center font-bold text-lg">Passer la commande</Text>
                </TouchableOpacity>
            </View>
       </View>
    </View>
